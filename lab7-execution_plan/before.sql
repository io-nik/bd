DROP INDEX IF EXISTS idx_visit_time_client;
DROP INDEX IF EXISTS idx_pay_doc_date_client_include_sum;
DROP INDEX IF EXISTS idx_training_visit_purchase;
DROP INDEX IF EXISTS idx_service_time_client;
DROP INDEX IF EXISTS idx_training_time_id;
DROP INDEX IF EXISTS idx_training_visit_training_client;
DROP INDEX IF EXISTS idx_training_personal_group;
DROP INDEX IF EXISTS idx_pay_doc_id_include_sum;
DROP INDEX IF EXISTS idx_service_pay_doc;
